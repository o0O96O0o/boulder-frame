...
The current UI accepts MP4 and QuickTime MOV files. `MAX_UPLOAD_BYTES` configures the upload limit
for both the API and Vite-built browser (default 2 GiB). Direct upload uses the external
