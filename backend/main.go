...
func main() {
	...
	h := &httpapi.Handler{Repo: repo, Store: store, Queue: publisher, Owner: cfg.DevelopmentOwner, URLTTL: cfg.URLTTL, MaxUploadBytes: cfg.MaxUploadBytes, PipelineVersion: cfg.PipelineVersion, ModelVersion: cfg.ModelVersion, DetectionSampleFPS: cfg.DetectionSampleFPS, WebBaseURL: cfg.WebBaseURL, Logger: logger}
