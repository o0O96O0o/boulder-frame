...
<a id="motivations-and-benefits-of-the-new-renderer"></a>
...
* **Type safety:** code generation to ensure type safety across the JS and [host platforms](glossary.md#host-platform). The code generation uses JavaScript component declarations as source of truth to generate C++ structs to hold the props. Mismatch between JavaScript and host component props triggers a build error.
...
* **Less serialization of data between JS and host platform**: React used to transfer data between JavaScript and *host platform* as serialized JSON. The new renderer improves the transfer of data by accessing JavaScript values directly using [JavaScript Interfaces (JSI)](glossary.md#javascript-interfaces-jsi).
