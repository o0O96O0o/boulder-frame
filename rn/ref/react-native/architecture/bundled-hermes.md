...
<a id="why-we-moved-to-bundled-hermes"></a>
...
<a id="how-this-will-impact-app-developers"></a>
...
<a id="android-users-on-new-architecture"></a>
...
<a id="android-users-on-new-architecture-building-on-windows"></a>
...
* Make sure the [environment is configured properly](../docs/environment-setup.md), with Android SDK & node.
...
<a id="can-users-still-use-another-engine"></a>
...
<a id="how-this-will-impact-contributor-and-extension-developers"></a>
...
<a id="how-is-bundled-hermes-working-under-the-hood"></a>
...
<a id="android-implementation-details"></a>
...
<a id="ios-implementation-details"></a>
...
<a id="building-hermes-from-source"></a>
...
<a id="im-afraid-this-change-is-impacting-me"></a>
