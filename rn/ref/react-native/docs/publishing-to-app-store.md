...
<a id="1-configure-release-scheme"></a>
...
![Xcode Release Scheme configuration](https://reactnative.dev/docs/assets/ConfigureReleaseScheme.png)![Xcode Release Scheme configuration](https://reactnative.dev/docs/assets/ConfigureReleaseSchemeDark.png)
...
<a id="2-build-app-for-release"></a>
