...
<a id="opting-out-since-087"></a>

### Opting outSince 0.87
...
<a id="keep-skiplibcheck-enabled"></a>
...
<a id="update-your-dependencies"></a>
...
**Advanced: Excluding an incompatible library**
...
<a id="new-codegentypes-namespace"></a>
...
<a id="refs-now-use-instance-types-since-087"></a>

### Refs now use `*Instance` typesSince 0.87
...
<a id="removal-of-static-types"></a>
...
<a id="other-breaking-changes"></a>

## Other breaking changes

<a id="initializecore-is-now-react-nativesetup-env-since-087"></a>

### `InitializeCore` is now `react-native/setup-env`Since 0.87
...
<a id="changes-to-animated-types"></a>
...
For the full list of aliases, see [`DeprecatedPropertiesAlias.d.ts`](https://github.com/facebook/react-native/blob/0.87-stable/packages/react-native/types/public/DeprecatedPropertiesAlias.d.ts).

<a id="removal-of-leftover-component-props"></a>
...
<a id="removal-of-internal-only-helper-types"></a>
...
**Does this change anything at runtime?**
...
**I maintain a library. Do I need to migrate before my users can upgrade?**
...
**An API I use isn't exported from `react-native`. Is that a bug?**
...
**Why were React Native's manual types replaced?**
...
See [Moving Towards a Stable JavaScript API](https://reactnative.dev/blog/2025/06/12/moving-towards-a-stable-javascript-api.md) for the full rationale.
