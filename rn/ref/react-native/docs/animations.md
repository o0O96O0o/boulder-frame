...
<a id="tracking-dynamic-values"></a>
...
<a id="scrollview-with-animated-event-example"></a>
...
<a id="panresponder-with-animated-event-example"></a>

#### PanResponder with Animated Event Example

<a id="responding-to-the-current-animation-value"></a>
...
<a id="setnativeprops"></a>

### `setNativeProps`

As mentioned [in the Direct Manipulation section](legacy/direct-manipulation.md), `setNativeProps` allows us to modify properties of native-backed components (components that are actually backed by native views, unlike composite components) directly, without having to `setState` and re-render the component hierarchy.
