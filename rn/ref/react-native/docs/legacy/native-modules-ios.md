...
Welcome to Native Modules for iOS. Please start by reading the [Native Modules Intro](native-modules-intro.md) for an intro to what native modules are.
...
<a id="create-custom-native-module-files"></a>
