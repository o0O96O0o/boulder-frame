...
<a id="setnativeprops-with-touchableopacity"></a>
...
<a id="composite-components-and-setnativeprops"></a>
...
<a id="forward-setnativeprops-to-a-child"></a>
...
<a id="setnativeprops-to-edit-textinput-value"></a>
...
You can use the [`clear`](../textinput.md#clear) method to clear the `TextInput` which clears the current input text using the same approach.

<a id="avoiding-conflicts-with-the-render-function"></a>
...
<a id="setnativeprops--shouldcomponentupdate"></a>
...
<a id="measureinwindowcallback"></a>
...
<a id="measurelayoutrelativetonativecomponentref-onsuccess-onfail"></a>
...
### setNativeProps with Composite Components
