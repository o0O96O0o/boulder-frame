...
<a id="build-only-one-abi-during-development-android-only"></a>
...
<a id="enable-configuration-caching-android-only"></a>
...
<a id="using-a-maven-mirror-android-only"></a>
...
<a id="using-this-approach-on-a-ci"></a>
