...
* `dropShadow`: A specific filter function available as part of the [`filter`](view-style-props.md#filter) View style prop.
...
See [View Style Props](view-style-props.md#boxshadow) for documentation.

<a id="dropshadow-android"></a>

### `dropShadow`Android

See [View Style Props](view-style-props.md#filter) for documentation.
...
Dependencies: `react-native-safe-area-context,@react-native-community/slider`
