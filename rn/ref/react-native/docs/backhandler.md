...
If your app shows an opened `Modal`, `BackHandler` will not publish any events ([see `Modal` docs](modal.md#onrequestclose)).
...
<a id="usage-with-react-navigation"></a>
