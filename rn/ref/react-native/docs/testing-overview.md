...
React Native comes with two such tools configured out of the box: [ESLint](https://eslint.org/) for linting and [TypeScript](typescript.md) for type checking.

<a id="writing-testable-code"></a>
...
<a id="testing-user-interactions"></a>
...
* make assertions using rendered text or [accessibility helpers](accessibility.md#accessibility-properties)
...
<a id="testing-rendered-output"></a>
