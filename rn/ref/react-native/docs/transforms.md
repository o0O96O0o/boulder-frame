...
<a id="️-decomposedmatrix-rotation-scalex-scaley-transformmatrix-translatex-translatey"></a>

### 🗑️ `decomposedMatrix`, `rotation`, `scaleX`, `scaleY`, `transformMatrix`, `translateX`, `translateY`

Deprecated

Use the [`transform`](transforms.md#transform) prop instead.
