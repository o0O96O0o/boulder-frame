...
<a id="creating-your-own-react-native-platform"></a>

## Creating your own React Native platform

The process of creating a React Native platform from scratch is still not very well documented - one of the goals of the New Architecture and [Fabric](../architecture/fabric-renderer.md) is to make maintaining a platform easier.
