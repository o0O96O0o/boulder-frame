...
<a id="limited-style-inheritance"></a>
...
<a id="android_hyphenationfrequency-android"></a>
...
<a id="datadetectortype-android"></a>
...
`role` communicates the purpose of a component to the user of an assistive technology. Has precedence over the [`accessibilityRole`](text.md#accessibilityrole) prop.
...
<a id="suppresshighlighting-ios"></a>
...
`TextLayout` object is a part of [`TextLayoutEvent`](text.md#textlayoutevent) callback and contains the measurement data for `Text` line.
...
<a id="textlayoutevent"></a>

### TextLayoutEvent

`TextLayoutEvent` object is returned in the callback as a result of a component layout change. It contains a key called `lines` with a value which is an array containing [`TextLayout`](text.md#textlayout) object corresponded to every rendered text line.
...
| Name   | Type                                             | Optional | Description                                           |
| ------ | ------------------------------------------------ | -------- | ----------------------------------------------------- |
| lines  | array of [TextLayout](text.md#textlayout)s | No       | Provides the TextLayout data for every rendered line. |
