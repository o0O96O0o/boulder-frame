...
Read more about using Hermes in React Native [here](hermes.md).

<a id="recommended-lazy-load-large-components"></a>
...
<a id="tip-avoid-module-side-effects"></a>
...
<a id="advanced-call-require-inline"></a>
...
<a id="advanced-automatically-inline-require-calls"></a>
...
<a id="pitfalls-of-inline-requires"></a>
...
<a id="advanced-use-random-access-module-bundles-non-hermes"></a>
