...
```
npx @react-native-community/cli@latest init TurboModuleExample --version "0.87.0"
```

<a id="native-persistent-storage"></a>
...
<a id="1-declare-typed-specification"></a>
...
<a id="3-write-application-code-using-the-turbo-native-module"></a>
...
<a id="4-write-your-native-platform-code"></a>
...
[](https://reactnative.dev/docs/assets/turbo-native-modules/turbo-native-modules-android.webm)

Now it's time to write some iOS platform code to make sure `localStorage` survives after the application is closed.

<a id="prepare-your-xcode-project"></a>
...
<a id="implement-localstorage-with-nsuserdefaults"></a>
...
<a id="register-the-native-module-in-your-app"></a>
...
<a id="build-and-run-your-code-on-a-simulator"></a>
...
[](https://reactnative.dev/docs/assets/turbo-native-modules/turbo-native-modules-ios.webm)
