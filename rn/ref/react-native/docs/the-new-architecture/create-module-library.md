...
<a id="extract-the-module-into-a-library"></a>
...
4. Continue filling the form until you reach the question *"What type of library do you want to develop?"* ![What type of Library](https://reactnative.dev/assets/images/what-library-82a9a474327fd86f807a7eedf6cd29fc.png)
...
<a id="2-copy-the-code-over-from-your-app"></a>

### 2. Copy the Code over from Your App

The rest of the guide assumes that you have a local Turbo Native Module in your app, created following the guidelines shown in the other guides in the website: platform specific Turbo Native Modules, or [cross-platform Turbo Native Modules](pure-cxx-modules.md). But it works also for Components and legacy architecture modules and components. You'll have to adapt the files you need to copy and update.
...
<a id="use-your-library-as-a-local-module"></a>
...
<a id="publish-the-library-on-npm"></a>
