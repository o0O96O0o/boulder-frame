...
<a id="showactionsheetwithoptions"></a>
...
* `cancelButtonTintColor` (string) - the [color](colors.md) used for the change the text color of the cancel button
...
<a id="showshareactionsheetwithoptions"></a>
