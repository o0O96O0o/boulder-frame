...
<a id="accessibility-properties"></a>
...
<a id="accessibilitylabelledby-android"></a>

### `accessibilityLabelledBy`Android

A reference to another element [nativeID](view.md#nativeid) used to build complex forms. The value of `accessibilityLabelledBy` should match the `nativeID` of the related element:
...
<a id="accessibilityignoresinvertcolors-ios"></a>
...
<a id="accessibilityliveregion-android"></a>
...
<a id="accessibilityshowslargecontentviewer-ios"></a>
...
<a id="accessibilitylargecontenttitle-ios"></a>
...
<a id="accessibilityviewismodal-ios"></a>
...
<a id="accessibilityelementshidden-ios"></a>
...
<a id="aria-labelledby-android"></a>
...
<a id="experimental_accessibilityorder"></a>
...
<a id="importantforaccessibility-android"></a>
...
<a id="onaccessibilityescape-ios"></a>
...
<a id="onaccessibilitytap-ios"></a>

### `onAccessibilityTap`iOS

Use this property to assign a custom function to be called when someone activates an accessible element by double tapping on it while it's selected.

<a id="onmagictap-ios"></a>
...
`role` communicates the purpose of a component and has precedence over the [`accessibilityRole`](accessibility.md#accessibilityrole) prop.
...
<a id="checking-if-a-screen-reader-is-enabled"></a>
...
<a id="sending-accessibility-events-android"></a>
...
<a id="testing-talkback-support-android"></a>
...
<a id="testing-voiceover-support-ios"></a>
