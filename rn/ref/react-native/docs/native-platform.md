...
* [Legacy Native Modules](legacy/native-modules-intro.md);
* [Legacy Native Components](legacy/native-components-android.md);
...
1. Native Modules
   ...
   * [Android & iOS](turbo-native-modules-introduction.md)
   * [Cross-Platform with C++](the-new-architecture/pure-cxx-modules.md)
   * [Advanced: Custom C++ Types](https://reactnative.dev/docs/the-new-architecture/custom-cxx-types.md)

2. Fabric Native Components
   <!-- -->
   * [Android & iOS](fabric-native-components-introduction.md)
